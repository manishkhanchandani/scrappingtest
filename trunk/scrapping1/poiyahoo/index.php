...
<table border="1" cellpadding="5" cellspacing="0">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_rsView['reviewfound']; ?> <?php if($row_rsView['cntTotalPoi']) { ?>[<?php echo number_format(($row_rsView['reviewfound']/$row_rsView['cntTotalPoi'])*100,2); ?> %]<?php } ?></td>
      <td><?php echo $noreview = $row_rsView['cntTotalPoiFound']-$row_rsView['reviewfound']; ?> <?php if($row_rsView['cntTotalPoi']) { ?>[<?php echo number_format(($noreview/$row_rsView['cntTotalPoi'])*100,2); ?> %]<?php } ?></td>
    </tr>
